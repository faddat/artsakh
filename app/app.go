...
import (
	...
	appparams "github.com/faddat/artsakh/app/params"
...
var (
	...
	DefaultNodeHome = func(appName string) string {
		return os.ExpandEnv("$HOME/artsakhd")
	}
...
func New(
	...
	app.artsakhKeeper = *artsakhkeeper.NewKeeper(
        appCodec, keys[artsakhtypes.StoreKey], keys[artsakhtypes.MemStoreKey],
	)
	...
	app.mm = module.NewManager(
		...
		transferModule,
		artsakh.NewAppModule(appCodec, app.artsakhKeeper),
